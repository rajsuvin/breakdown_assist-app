...
class User_billpage extends StatefulWidget {
  const User_billpage({super.key});

  @override
  State<User_billpage> createState() => _User_billpageState();
}

class _User_billpageState extends State<User_billpage> {
  double rating = 0;
  @override
